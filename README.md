...
- **Desktop & fonts** — GNOME dark theme, volume overamplification enabled (up to 150%), GNOME Software autostart/search disabled, Fira Code Nerd Font and MS core fonts.
